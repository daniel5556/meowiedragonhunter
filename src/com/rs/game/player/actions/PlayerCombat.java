	...
	public int mageAttack(final Player player, int spellId, boolean autocast) {
		...
		if (player.getCombatDefinitions().getSpellBook() == 192) {
			...
			case 25:// Blood Blitz
				...
				base_mage_xp = 45;
				blood_spell = true;
				delayMagicHit(2, getMagicHit(player, getRandomMagicMaxHit(player, /*(int) (*/250/* * (1.0 + (player.getSkills().getLevelForXp(Skills.MAGIC) - 80)/100.0 ))*/)));
				World.sendProjectile(player, target, 374, 18, 18, 50, 50, 0, 0);
				return 4;
			case 21:// Ice Blitz
				player.setNextGraphics(new Graphics(366));
				...
				freeze_time = 15000;
				magic_sound = 169;
				delayMagicHit(2, getMagicHit(player, getRandomMagicMaxHit(player, /*(int) (*/260/* * (1.0 + (player.getSkills().getLevelForXp(Skills.MAGIC) - 82)/100.0 ))*/)));
			...
			case 27:// blood barrage
				attackTarget(getMultiAttackTargets(player), new MultiAttack() {
					...
					public boolean attack() {
						...
						base_mage_xp = 51;
						max_poison_hit = 40;
						int damage = getRandomMagicMaxHit(player, /*(int) (*/290/* * (1.0 + (player.getSkills().getLevelForXp(Skills.MAGIC) - 92)/100.0 ))*/);
						delayMagicHit(2, getMagicHit(player, damage));
						World.sendProjectile(player, target, 390, 18, 18, 50, 50, 0, 0);
						if(!nextTarget) {
							if(damage == -1)
			...
			case 23: // ice barrage
				...
				attackTarget(getMultiAttackTargets(player), new MultiAttack() {
					...
					public boolean attack() {
						...
						base_mage_xp = 52;
						int damage = getRandomMagicMaxHit(player, /*(int) (*/300/* * (1.0 + (player.getSkills().getLevelForXp(Skills.MAGIC) - 94)/100.0 ))*/);
		...
		if (player.getCombatDefinitions().isUsingSpecialAttack()) {
			...
			if (weaponId != -1) {
				...
				if (weaponName.contains("throwing axe")
					...
					int damage = 0;
					int ammoId = player.getEquipment().getAmmoId();
					if (ammoId != -1 && Utils.getRandom(100) >= 80) {
						switch (ammoId) {
						case 9237:
						...
						case 9243:
							damage = getRandomMaxHit(player, weaponId,
									attackStyle, true, false, 1.20, true);
						...
						case 9244:
							damage = getRandomMaxHit(
									...
									true,
									true,
									!Combat.hasAntiDragProtection(target) ? 1.50
											: 1.0, true);
						...
						case 9245:
							damage = getRandomMaxHit(player, weaponId,
									attackStyle, true, true, 1.20, true);
		...
		WorldTasksManager.schedule(new WorldTask() {
			...
			public void run() {
				for (Hit hit : hits) {
					...
					int damage = hit.getDamage() > target.getHitpoints() ? target
							.getHitpoints() : hit.getDamage();
							if ((damage >= max_hit * 0.95)
									&& (hit.getLook() == HitLook.MAGIC_DAMAGE
									|| hit.getLook() == HitLook.RANGE_DAMAGE || hit
									.getLook() == HitLook.MELEE_DAMAGE)) {
								hit.setCriticalMark();
								double percent = (double)damage/max_hit*100;
								if(!Double.isNaN(percent)) {
									player.getPackets().sendGameMessage("<col=ffff00>That hit was " + percent + "% of your current max hit!</col>");
								}
							}
							if (hit.getLook() == HitLook.RANGE_DAMAGE
									|| hit.getLook() == HitLook.MELEE_DAMAGE) {
		...
		if (target instanceof Player) {
			...
			if (n instanceof Familiar) {
				...
				if (n.getId() == 14578) {
				 ...
				 if (i1 > paramPlayer.getSkills().getLevel(18))
          {
            paramPlayer.getPackets().sendGameMessage("You need at least a slayer level of " + i1 + " to fight this.");
            

            return false;
          }
        }
        else if ((((NPC)localObject).getId() == 1832) || (((NPC)localObject).getId() == 5750))
        {
          if (paramPlayer.getSkills().getLevel(18) < 7)
          {
            paramPlayer.getPackets().sendGameMessage("You need at least a slayer level of 7 to fight this.");
            return false;
          }
        }
        else if ((((NPC)localObject).getId() == 1600) || (((NPC)localObject).getId() == 1601) || (((NPC)localObject).getId() == 1602) || (((NPC)localObject).getId() == 1603) || (((NPC)localObject).getId() == 7787) || (((NPC)localObject).getId() == 7798) || (((NPC)localObject).getId() == 10695))
        {
          if (paramPlayer.getSkills().getLevel(18) < 10)
          {
            paramPlayer.getPackets().sendGameMessage("You need at least a slayer level of 10 to fight this.");
            return false;
          }
        }
        else if (((NPC)localObject).getId() == 1612)
        {
          if (paramPlayer.getSkills().getLevel(18) < 15)
          {
            paramPlayer.getPackets().sendGameMessage("You need at least a slayer level of 15 to fight this.");
            return false;
          }
        }
        else if ((((NPC)localObject).getId() == 1831) || (((NPC)localObject).getId() == 10696))
        {
          if (paramPlayer.getSkills().getLevel(18) < 17)
          {
            paramPlayer.getPackets().sendGameMessage("You need at least a slayer level of 17 to fight this.");
            return false;
          }
        }
        else if ((((NPC)localObject).getId() == 1631) || (((NPC)localObject).getId() == 1632))
        {
          if (paramPlayer.getSkills().getLevel(18) < 20)
          {
            paramPlayer.getPackets().sendGameMessage("You need at least a slayer level of 20 to fight this.");
            return false;
          }
        }
        else if ((((NPC)localObject).getId() == 2804) || (((NPC)localObject).getId() == 2805) || (((NPC)localObject).getId() == 2806))
        {
          if (paramPlayer.getSkills().getLevel(18) < 22)
          {
            paramPlayer.getPackets().sendGameMessage("You need at least a slayer level of 22 to fight this.");
            return false;
          }
        }
        else if ((((NPC)localObject).getId() == 1620) || (((NPC)localObject).getId() == 4227))
        {
          if (paramPlayer.getSkills().getLevel(18) < 25)
          {
            paramPlayer.getPackets().sendGameMessage("You need at least a slayer level of 25 to fight this.");
            return false;
          }
        }
        else if ((((NPC)localObject).getId() == 1633) || (((NPC)localObject).getId() == 1634) || (((NPC)localObject).getId() == 1635) || (((NPC)localObject).getId() == 1636) || (((NPC)localObject).getId() == 6216) || (((NPC)localObject).getId() == 8598) || (((NPC)localObject).getId() == 8616) || (((NPC)localObject).getId() == 10697))
        {
          if (paramPlayer.getSkills().getLevel(18) < 30)
          {
            paramPlayer.getPackets().sendGameMessage("You need at least a slayer level of 30 to fight this.");
            return false;
          }
        }
        else if ((((NPC)localObject).getId() == 1620) || (((NPC)localObject).getId() == 4227))
        {
          if (paramPlayer.getSkills().getLevel(18) < 32)
          {
            paramPlayer.getPackets().sendGameMessage("You need at least a slayer level of 32 to fight this.");
            return false;
          }
        }
        else if (((NPC)localObject).getId() == 3153)
        {
          if (paramPlayer.getSkills().getLevel(18) < 33)
          {
            paramPlayer.getPackets().sendGameMessage("You need at least a slayer level of 33 to fight this.");
            return false;
          }
        }
        else if (((NPC)localObject).getId() == 7823)
        {
          if (paramPlayer.getSkills().getLevel(18) < 35)
          {
            paramPlayer.getPackets().sendGameMessage("You need at least a slayer level of 35 to fight this.");
            return false;
          }
        }
        else if ((((NPC)localObject).getId() == 3201) || (((NPC)localObject).getId() == 3202))
        {
          if (paramPlayer.getSkills().getLevel(18) < 37)
          {
            paramPlayer.getPackets().sendGameMessage("You need at least a slayer level of 37 to fight this.");
            return false;
          }
        }
        else if (((NPC)localObject).getId() == 5751)
        {
          if (paramPlayer.getSkills().getLevel(18) < 39)
          {
            paramPlayer.getPackets().sendGameMessage("You need at least a slayer level of 39 to fight this.");
            return false;
          }
        }
        else if ((((NPC)localObject).getId() == 1616) || (((NPC)localObject).getId() == 1617) || (((NPC)localObject).getId() == 4228) || (((NPC)localObject).getId() == 5417) || (((NPC)localObject).getId() == 5418) || (((NPC)localObject).getId() == 11365))
        {
          if (paramPlayer.getSkills().getLevel(18) < 40)
          {
            paramPlayer.getPackets().sendGameMessage("You need at least a slayer level of 40 to fight this.");
            return false;
          }
        }
        else if (((NPC)localObject).getId() == 2850)
        {
          if (paramPlayer.getSkills().getLevel(18) < 42)
          {
            paramPlayer.getPackets().sendGameMessage("You need at least a slayer level of 42 to fight this.");
            return false;
          }
        }
        else if ((((NPC)localObject).getId() == 1643) || (((NPC)localObject).getId() == 1644) || (((NPC)localObject).getId() == 1645) || (((NPC)localObject).getId() == 1646) || (((NPC)localObject).getId() == 1647))
        {
          if (paramPlayer.getSkills().getLevel(18) < 45)
          {
            paramPlayer.getPackets().sendGameMessage("You need at least a slayer level of 45 to fight this.");
            return false;
          }
        }
        else if ((((NPC)localObject).getId() == 1618) || (((NPC)localObject).getId() == 1619) || (((NPC)localObject).getId() == 6215) || (((NPC)localObject).getId() == 7642) || (((NPC)localObject).getId() == 7643))
        {
          if (paramPlayer.getSkills().getLevel(18) < 50)
          {
            paramPlayer.getPackets().sendGameMessage("You need at least a slayer level of 50 to fight this.");
            return false;
          }
        }
        else if ((((NPC)localObject).getId() == 8548) || (((NPC)localObject).getId() == 8549) || (((NPC)localObject).getId() == 8575) || (((NPC)localObject).getId() == 8576))
        {
          if (paramPlayer.getSkills().getLevel(18) < 51)
          {
            paramPlayer.getPackets().sendGameMessage("You need at least a slayer level of 51 to fight this.");
            return false;
          }
        }
        else if ((((NPC)localObject).getId() == 1637) || (((NPC)localObject).getId() == 1638) || (((NPC)localObject).getId() == 1639) || (((NPC)localObject).getId() == 1640) || (((NPC)localObject).getId() == 1641) || (((NPC)localObject).getId() == 1642) || (((NPC)localObject).getId() == 7459) || (((NPC)localObject).getId() == 7460) || (((NPC)localObject).getId() == 8599) || (((NPC)localObject).getId() == 8617))
        {
          if (paramPlayer.getSkills().getLevel(18) < 52)
          {
            paramPlayer.getPackets().sendGameMessage("You need at least a slayer level of 52 to fight this.");
            return false;
          }
        }
        else if ((((NPC)localObject).getId() == 1623) || (((NPC)localObject).getId() == 1626) || (((NPC)localObject).getId() == 1627) || (((NPC)localObject).getId() == 1628) || (((NPC)localObject).getId() == 1629) || (((NPC)localObject).getId() == 1630))
        {
          if (paramPlayer.getSkills().getLevel(18) < 55)
          {
            paramPlayer.getPackets().sendGameMessage("You need at least a slayer level of 55 to fight this.");
            return false;
          }
        }
        else if ((((NPC)localObject).getId() == 4353) || (((NPC)localObject).getId() == 4354) || (((NPC)localObject).getId() == 4355) || (((NPC)localObject).getId() == 4356) || (((NPC)localObject).getId() == 4357))
        {
          if (paramPlayer.getSkills().getLevel(18) < 58)
          {
            paramPlayer.getPackets().sendGameMessage("You need at least a slayer level of 58 to fight this.");
            return false;
          }
        }
        else if ((((NPC)localObject).getId() == 1604) || (((NPC)localObject).getId() == 1605) || (((NPC)localObject).getId() == 1606) || (((NPC)localObject).getId() == 1607) || (((NPC)localObject).getId() == 7801) || (((NPC)localObject).getId() == 7802) || (((NPC)localObject).getId() == 7803) || (((NPC)localObject).getId() == 7804))
        {
          if (paramPlayer.getSkills().getLevel(18) < 60)
          {
            paramPlayer.getPackets().sendGameMessage("You need at least a slayer level of 60 to fight this.");
            return false;
          }
        }
        else if ((((NPC)localObject).getId() == 6220) || (((NPC)localObject).getId() == 6230) || (((NPC)localObject).getId() == 6256) || (((NPC)localObject).getId() == 6276))
        {
          if (paramPlayer.getSkills().getLevel(18) < 63)
          {
            paramPlayer.getPackets().sendGameMessage("You need at least a slayer level of 63 to fight this.");
            return false;
          }
        }
        else if (((NPC)localObject).getId() == 1624)
        {
          if (paramPlayer.getSkills().getLevel(18) < 65)
          {
            paramPlayer.getPackets().sendGameMessage("You need at least a slayer level of 65 to fight this.");
            return false;
          }
        }
        else if ((((NPC)localObject).getId() == 6219) || (((NPC)localObject).getId() == 6229) || (((NPC)localObject).getId() == 6255) || (((NPC)localObject).getId() == 6277))
        {
          if (paramPlayer.getSkills().getLevel(18) < 68)
          {
            paramPlayer.getPackets().sendGameMessage("You need at least a slayer level of 68 to fight this.");
            return false;
          }
        }
        else if ((((NPC)localObject).getId() == 1608) || (((NPC)localObject).getId() == 1609) || (((NPC)localObject).getId() == 4229))
        {
          if (paramPlayer.getSkills().getLevel(18) < 70)
          {
            paramPlayer.getPackets().sendGameMessage("You need at least a slayer level of 70 to fight this.");
            return false;
          }
        }
        else if ((((NPC)localObject).getId() == 3068) || (((NPC)localObject).getId() == 3069) || (((NPC)localObject).getId() == 3070) || (((NPC)localObject).getId() == 3071))
        {
          if (paramPlayer.getSkills().getLevel(18) < 72)
          {
            paramPlayer.getPackets().sendGameMessage("You need at least a slayer level of 72 to fight this.");
            return false;
          }
        }
        else if ((((NPC)localObject).getId() == 1610) || (((NPC)localObject).getId() == 1827) || (((NPC)localObject).getId() == 6389) || (((NPC)localObject).getId() == 9087))
        {
          if (paramPlayer.getSkills().getLevel(18) < 75)
          {
            paramPlayer.getPackets().sendGameMessage("You need at least a slayer level of 75 to fight this.");
            return false;
          }
        }
        else if ((((NPC)localObject).getId() == 1613) || (((NPC)localObject).getId() == 10702) || (((NPC)localObject).getId() == 9172))
        {
          if (paramPlayer.getSkills().getLevel(18) < 80)
          {
            paramPlayer.getPackets().sendGameMessage("You need at least a slayer level of 80 to fight this.");
            return false;
          }
        }
        else if ((((NPC)localObject).getId() == 6221) || (((NPC)localObject).getId() == 6231) || (((NPC)localObject).getId() == 6257) || (((NPC)localObject).getId() == 6258))
        {
          if (paramPlayer.getSkills().getLevel(18) < 83)
          {
            paramPlayer.getPackets().sendGameMessage("You need at least a slayer level of 83 to fight this.");
            return false;
          }
        }
        else if ((((NPC)localObject).getId() == 1615) || (((NPC)localObject).getId() == 4230) || (((NPC)localObject).getId() == 9086))
        {
          if (paramPlayer.getSkills().getLevel(18) < 85)
          {
            paramPlayer.getPackets().sendGameMessage("You need at least a slayer level of 85 to fight this.");
            return false;
          }
        }
        else if (((NPC)localObject).getId() == 2783)
        {
          if (paramPlayer.getSkills().getLevel(18) < 90)
          {
            paramPlayer.getPackets().sendGameMessage("You need at least a slayer level of 90 to fight this.");
            return false;
          }
        }
        else if ((((NPC)localObject).getId() == 14698) || (((NPC)localObject).getId() == 14699) || (((NPC)localObject).getId() == 14696) || (((NPC)localObject).getId() == 14697))
        {
          if (paramPlayer.getSkills().getLevel(18) < 95)
          {
            paramPlayer.getPackets().sendGameMessage("You need at least a slayer level of 95 to fight this.");
            return false;
          }
        }
