...
public enum SummoningPouch {
	...
	SPIRIT_TZ_KIH_POUCH(12808, 22, 96.8, 7361, 1.1, 3, new Item(12160),
	...
	HYDRA_POUCH(12025, 80, 140.8, 9488, 1.6, 9, new Item(12159), new Item(571), new Item(12115), new Item(12183, 128)),

	SPIRIT_DAGANNOTH_POUCH(12017, 83, 364.8, 6804, 4.1, 9, new Item(12160), new Item(6155), new Item(12115), new Item(12183, 1)),

	UNICORN_STALLION_POUCH(12039, 89, 154.4, 6822, 1.8, 9, new Item(12159), new Item(237), new Item(12115), new Item(12183, 203)),
