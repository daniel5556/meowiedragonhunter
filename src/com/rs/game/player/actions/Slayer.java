...
public class Slayer {
	...
	public enum Master {
		...
		VANNAKA(
				...
				"Gargoyles", "Wolves", "Aberrant spectres", "Basilisks", "Wild dog", "Bloodvelds",
		...
		CHAELDAR(
				...
				"Hobgoblins", "Pyrefiends", "Aberrant spectres",
		...
		SUMONA(
				...
				"Jungle strykewyrms", "Kurasks", "Mutated jadinko", "Nechryaels", "Red Dragons",
		...
		LAPALOK(
				...
				"Dagannoth", "Iron dragons", "Steel dragons",
		...
		KURADAL(9085, "", 110, 75, new int[] { 190, 270 }, "Aberrant spectres",
				...
				"Living rock creatures", "Mithril dragons",
