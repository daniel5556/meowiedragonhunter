...
public class Thieving {
    ...
    public static void handleStalls(final Player player, final WorldObject object) {
        ...
        for (final Stalls stall : Stalls.values()) {
            for (int i = 0; i < stall.getObjectId().length; i++) {
                if (stall.getObjectId()[i] == object.getId()) {
                    try {
                        final WorldObject emptyStall = new WorldObject(stall.getReplaceObject()[i] != 0 || stall.getReplaceObject()[i] != 1 ? stall.getReplaceObject()[i] : 34381, 10, object.getRotation(), object.getX(), object.getY(), object.getPlane());
    ...
    public enum Stalls {
        VEGETABAL(new int[]{66696}, 2, new int[]{1957, 1965, 1942, 1982, 1550}, 1, 2, 10, new int[]{66697}),

        CAKE(new int[]{34384}, 5, new int[]{1891, 1901, 2309}, 1, 2.5, 16, new int[]{34381}),

        CRAFTING(new int[]{4874, 6166, 51654, 66700}, 5, new int[]{1755, 1592, 1597}, 1, 7, 16, new int[]{34381, 34381, 51655, 66701}),

        MONKEY_FOOD(new int[]{0}, 5, new int[]{1963}, 1, 7, 16, new int[]{34381}),

        MONKEY_GENERAL(new int[]{0}, 5, new int[]{1931, 2347, 590}, 1, 7, 16, new int[]{34381}),

        TEA_STALL(new int[]{635}, 5, new int[]{712}, 1, 7, 16, new int[]{34381}),

        SILK_STALL(new int[]{629, 20344, 34383}, 20, new int[]{950}, 1, 8, 24, new int[]{34381}),

        WINE_STALL(new int[]{14011, 2046, 66694}, 22, new int[]{1937, 1993, 1987, 1935, 7919}, 1, 16, 27, new int[]{2046, 2046, 66695}),

        SEED_STALL(new int[]{2047, 7053, 61839, 66698}, 27, new int[]{5096, 5097, 5098, 5099, 5100, 5101, 5102, 5103, 5105}, 30, 11, 10, new int[]{2047, 2047, 2047, 66699}),

        FUR_STALL(new int[]{632, 4278, 34387}, 35, new int[]{6814, 958}, 1, 15, 36, new int[]{34381, 34381, 34381}),

        FISH_STALL(new int[]{4277, 4705}, 42, new int[]{331, 359, 377}, 1, 16, 42, new int[]{34381, 34381}),

        CROSSBOW_STALL(new int[]{17031}, 49, new int[]{877, 9420, 9440}, 1, 11, 52, new int[]{34381}),

        SILVER_STALL(new int[]{6164, 34382}, 50, new int[]{442}, 1, 30, 54, new int[]{34381, 34381}),

        SPICE_STALL(new int[]{6572, 20348, 34386}, 65, new int[]{2007}, 1, 80, 81, new int[]{34381, 34381, 34381}),

        MAGIC_STALL(new int[]{4877}, 65, new int[]{556, 557, 554, 555, 563}, 30, 80, 100, new int[]{34381}),

        SCIMITAR_STALL(new int[]{4878}, 65, new int[]{1323}, 1, 80, 100, new int[]{34381}),

        GEM_STALL(new int[]{6162, 34385, 35437, 56846}, 75, new int[]{1623, 1621, 1619, 1617}, 1, 180, 16, new int[]{34381, 34381, 34381, 34381});
        private int[] item;
        private int level;
        private int amount;
