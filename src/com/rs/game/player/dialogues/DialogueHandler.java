...
public final class DialogueHandler {
	...
	public static final void init() {
		try {
			...
			handledDialogues.put("Thok", value43);
			Class<Dialogue> value44 = (Class<Dialogue>) Class
					.forName(Korasi.class.getCanonicalName());
			handledDialogues.put("Korasi", value44);	
			Class<Dialogue> value45 = (Class<Dialogue>) Class
					.forName(FloatingEssence.class.getCanonicalName());
			handledDialogues.put("FloatingEssence", value45);	
			Class<Dialogue> value46 = (Class<Dialogue>) Class
					.forName(Raptor.class.getCanonicalName());
			handledDialogues.put("Raptor", value46);
			...
			Class<Dialogue> value48 = (Class<Dialogue>) Class
					.forName(TalentScout.class.getCanonicalName());
			...
			handledDialogues.put("SlayerMaster", (Class<Dialogue>) Class.forName(SlayerMaster.class.getCanonicalName()));
			handledDialogues.put("AssignTask", (Class<Dialogue>) Class.forName(AssignTask.class.getCanonicalName()));
		} catch (Throwable e) {
			Logger.handle(e);
		}
	}
